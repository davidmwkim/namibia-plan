...
(function (root, factory) {
  ...
  const SURFACE_VIS = {
    paved:  { dash: null,          color: null,      barCss: 'surf-paved'  },
    gravel: { dash: '9 7',         color: '#e5e7eb', barCss: 'surf-gravel' },
    dirt:   { dash: '10 5 2 5',    color: '#d8b48c', barCss: 'surf-dirt'   },
    sand:   { dash: '2 8',         color: '#f2d9a8', barCss: 'surf-sand'   },
    unpaved:{ dash: '10 5 2 5',    color: '#d8b48c', barCss: 'surf-dirt'   },
    urban:  { dash: '2 6',         color: '#ffffff', barCss: 'surf-urban'  },
    mixed:  { dash: '9 7',         color: '#e5e7eb', barCss: 'surf-mixed'  }
  };
