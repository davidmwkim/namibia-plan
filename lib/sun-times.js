...
(function (root, factory) {
  ...
  // Parse "15 mins" / "1 hour" / "1 hour 12 mins" / "2 hours 4 mins" / "30 secs"
  // → minutes (as a float, so sub-minute steps don't get rounded to zero and
  // cumulative time accumulates correctly across many short urban turns).
  function parseDurationToMinutes(text) {
    ...
    if (secMatch) m += Number(secMatch[1]) / 60;
    return m;
  }
